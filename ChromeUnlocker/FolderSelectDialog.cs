...
namespace FolderBrowser
{
    ...
    // Source: http://stackoverflow.com/a/15386992
public class FolderBrowser
{
    public string DirectoryPath { get; set; }

    public DialogResult ShowDialog(IWin32Window owner = null, String wndTitle = "")
    {
    ...
    public Boolean OpenDialog(IWin32Window owner = null, String wndTitle = "")
    {
        return ShowDialog(owner, wndTitle) == DialogResult.OK;
    }
